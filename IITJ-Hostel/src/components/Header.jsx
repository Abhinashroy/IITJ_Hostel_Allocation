...
//         </li>
//         <li>
//           <Link to="/hostels" className="navbar-link">Hostels</Link>
//         </li>
//         <li>
//           <Link to="/allocate-room" className="navbar-link">Allocate Room</Link>
//         </li>
//         <li>
  ...
  return (
    <header className="p-4 flex justify-between">
      <Link to={'/'} className="flex items-center gap-1">
        ...
        <span className="font-bold text-xl">IITJ Hostels</span>
      </Link>
